...
@bp.on.private_message(state=SubjectCreationStates.SUBJECT_LANG)
...
@bp.on.private_message(state=SubjectCreationStates.SUBJECT_LABEL)
...
@bp.on.private_message(state=SubjectCreationStates.SUBJECT_NAME)
...
@bp.on.private_message(state=SubjectCreationStates.SUBJECT_SHORTS)
...
@bp.on.private_message(state=SubjectCreationStates.SUBJECT_EMOJI)
